document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    const validateField = function (field) {
      ...
      if (field.dataset.required !== undefined || field.hasAttribute('required')) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .catch(function () {
          let errorMsg = contactForm.querySelector('.form-error-general');
          if (!errorMsg) {
            errorMsg = document.createElement('div');
            errorMsg.className = 'form-error-general';
  ...
  const animatableSelector = '.animate-on-scroll, [data-animate]';

  const animatableElements = document.querySelectorAll(animatableSelector);
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אסטרוסלופ משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e7d582e6-dbdb-42c8-9e12-59102e035bb0',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e7d582e6-dbdb-42c8-9e12-59102e035bb0';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e7d582e6-dbdb-42c8-9e12-59102e035bb0';
